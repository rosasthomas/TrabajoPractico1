...
/** \brief realiza el factorial de dos operandos
...
/** \brief calcula todos los casos de operaciones
 *
 * \param float recibe el primero operando
 * \param float recibe el segundo operando
 * \return float devuelve los resultados
 *
 */
